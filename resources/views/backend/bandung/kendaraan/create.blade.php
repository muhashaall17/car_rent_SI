                            ...
                            <div class="row">
                                <div class="col-md-6 my-2">
                                    <div class="form-group">
                                        <label class="my-1" for="cabang_id">Cabang</label>
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="form-group">
                                        <label class="my-1" class="font-weight-bold" for="jenis_kendaraan">Jenis Kendaraan</label>
                                ...
                                <div class="col-md-6 my-2">
                                    <div class="form-group">
                                        <label class="my-1" class="font-weight-bold" for="plat_nomor">Plat Nomor</label>
                                        <input type="text" name="plat_nomor" class="form-control" id="plat_nomor">
                                    </div>
                                </div>
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="merk">Merk</label>
                                    <input type="text" name="merk" class="form-control" id="merk">
                                </div>
                            </div>
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="nama_kendaraan">Nama Kendaraan</label>
                                    <input type="text" name="nama_kendaraan" class="form-control" id="nama_kendaraan">
                                </div>
                            </div>
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="tahun_pembuatan">Tahun Pembuatan</label>
                                    <input type="text" name="tahun_pembuatan" class="form-control" id="tahun_pembuatan">
                                </div>
                            </div>
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="warna">Warna</label>
                                    <input type="text" name="warna" class="form-control" id="warna">
                                </div>
                            </div>
                            <div class="col-md-6 my-2">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="harga_sewa">Harga Sewa</label>
                                    <input type="text" name="harga_sewa" class="form-control" id="harga">
                                </div>
                            </div>
                            <div class="col-md-6 my-3">
                                <div class="form-group">
                                    <label class="my-1" class="font-weight-bold" for="gambar">Gambar</label>
                                    <br>
