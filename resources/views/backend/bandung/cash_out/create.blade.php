                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('CashOut.store')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold" for="tgl_cout">Tanggal Keluar Cash</label>
                                        <input type="date" name="tgl_cout" class="form-control" id="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a type="button" class="btn btn-info" href="{{ route('CashOut.index')}}">Kembali</a>
                                </div>
                            </div>
                        </form>
                    </div>
