            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="#" method='POST' class="d-flex align-items-center">
                        ...
                        <a class="btn btn-info mr-2" href="$"><i class="fas fa-plus mr-2"></i>Tambah Rental Item</a>

                        <a class="btn btn-success" href="#"><i class="fas fa-file-excel mr-2"></i> Export Excel</a>
                    </form>

                    <div class="card-body">
                        <table id="Cabang" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>ID Rental</th>
                                    <th>ID Kendaraan</th>
                                    <th>Driver ID</th>
                                    <th>Book Date Start</th>
                                    <th>Book Date End</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($rental_item as $p)
                                    <tr>    
                                        <td>{{ $p->rental_id }}</td>
                                        <td>{{ $p->kendaraan_id }}</td>
                                        <td>{{ $p->driver_id }}</td>
                                        <td>{{ $p->book_date_start }}</td>
                                        <td>{{ $p->book_date_end }}</td>
                                        <td>
